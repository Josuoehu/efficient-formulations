...
(:init
  ...
  (connected_storearea_transitarea depot1-2-2 loadarea)
  (connected_transitarea_storearea loadarea depot1-2-2)
  ...
  (available hoist0)
  (at_storearea hoist1 depot1-1-1)
  (available hoist1)
  (at_storearea hoist2 depot2-1-1)
  (available hoist2)
  (at_storearea hoist3 depot3-1-1)
  (available hoist3)
)
