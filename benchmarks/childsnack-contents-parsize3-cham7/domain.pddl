...
(:predicates 
  ...
  (sandwich_contents ?s - SANDWICH ?d0 - CONTENT-DESCRIPTION ?d1 - CONTENT-DESCRIPTION ?d2 - CONTENT-DESCRIPTION)
...
:parameters (?s - SANDWICH ?b - BREAD-PORTION ?c0 - CONTENT-PORTION ?c1 - CONTENT-PORTION ?c2 - CONTENT-PORTION ?d0 - CONTENT-DESCRIPTION ?d1 - CONTENT-DESCRIPTION ?d2 - CONTENT-DESCRIPTION)
:precondition 
...
:parameters (?s - SANDWICH ?d0 - CONTENT-DESCRIPTION ?d1 - CONTENT-DESCRIPTION ?d2 - CONTENT-DESCRIPTION ?c - CHILD ?t - TRAY ?p - PLACE)
:precondition 
  (and (sandwich_contents ?s ?d0 ?d1 ?d2)
  (ontray ?s ?t)
  (waiting ?c ?p)
  (likes ?c ?d0)
  (likes ?c ?d1)
