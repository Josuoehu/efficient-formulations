...
(:goal   (and (contains_shot_cocktail shot1 cocktail1)
  (contains_shot_cocktail shot2 cocktail5)
  (contains_shot_cocktail shot3 cocktail7)
  (contains_shot_cocktail shot4 cocktail4)
  (contains_shot_cocktail shot5 cocktail2)
  (contains_shot_cocktail shot6 cocktail6)
  (contains_shot_cocktail shot7 cocktail3)
  (contains_shot_ingredient shot8 ingredient1)))
)
