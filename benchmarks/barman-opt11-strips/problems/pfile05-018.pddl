...
(:goal   (and (contains_shot_cocktail shot1 cocktail6)
  ...
  (contains_shot_cocktail shot6 cocktail3)
  (contains_shot_cocktail shot7 cocktail5)
  (contains_shot_cocktail shot8 cocktail1)))
)
