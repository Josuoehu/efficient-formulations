...
(:goal   (and (contains_shot_cocktail shot1 cocktail4)
  (contains_shot_cocktail shot2 cocktail8)
  (contains_shot_cocktail shot3 cocktail1)
  (contains_shot_cocktail shot4 cocktail2)
  (contains_shot_cocktail shot5 cocktail3)
  (contains_shot_cocktail shot6 cocktail5)
  (contains_shot_cocktail shot7 cocktail7)
  (contains_shot_cocktail shot8 cocktail6)))
)
