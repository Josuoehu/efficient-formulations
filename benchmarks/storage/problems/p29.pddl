...
(:objects 
  ...
  depot4-1-1 - STOREAREA
  depot4-1-2 - STOREAREA
  depot4-1-3 - STOREAREA
  depot4-2-1 - STOREAREA
  depot4-2-2 - STOREAREA
  depot4-2-3 - STOREAREA
  depot4-3-1 - STOREAREA
  depot4-3-2 - STOREAREA
  depot4-3-3 - STOREAREA
  ...
  container-4-0 - STOREAREA
  container-4-1 - STOREAREA
  container-4-2 - STOREAREA
  hoist0 - HOIST
  hoist1 - HOIST
  hoist2 - HOIST
  hoist3 - HOIST
...
(:init
  ...
  (connected_storearea_storearea depot4-1-1 depot4-2-1)
  (connected_storearea_storearea depot4-1-1 depot4-1-2)
  (connected_storearea_storearea depot4-1-2 depot4-2-2)
  (connected_storearea_storearea depot4-1-2 depot4-1-3)
  (connected_storearea_storearea depot4-1-2 depot4-1-1)
  (connected_storearea_storearea depot4-1-3 depot4-2-3)
  (connected_storearea_storearea depot4-1-3 depot4-1-2)
  (connected_storearea_storearea depot4-2-1 depot4-1-1)
  (connected_storearea_storearea depot4-2-1 depot4-3-1)
  (connected_storearea_storearea depot4-2-1 depot4-2-2)
  (connected_storearea_storearea depot4-2-2 depot4-1-2)
  (connected_storearea_storearea depot4-2-2 depot4-3-2)
  (connected_storearea_storearea depot4-2-2 depot4-2-3)
  (connected_storearea_storearea depot4-2-2 depot4-2-1)
  (connected_storearea_storearea depot4-2-3 depot4-1-3)
  (connected_storearea_storearea depot4-2-3 depot4-3-3)
  (connected_storearea_storearea depot4-2-3 depot4-2-2)
  (connected_storearea_storearea depot4-3-1 depot4-2-1)
  (connected_storearea_storearea depot4-3-1 depot4-3-2)
  (connected_storearea_storearea depot4-3-2 depot4-2-2)
  (connected_storearea_storearea depot4-3-2 depot4-3-3)
  (connected_storearea_storearea depot4-3-2 depot4-3-1)
  (connected_storearea_storearea depot4-3-3 depot4-2-3)
  (connected_storearea_storearea depot4-3-3 depot4-3-2)
  ...
  (in_storearea_depot depot4-1-1 depot4)
  (in_storearea_depot depot4-1-2 depot4)
  (in_storearea_depot depot4-1-3 depot4)
  (in_storearea_depot depot4-2-1 depot4)
  (in_storearea_depot depot4-2-2 depot4)
  (in_storearea_depot depot4-2-3 depot4)
  (in_storearea_depot depot4-3-1 depot4)
  (in_storearea_depot depot4-3-2 depot4)
  (in_storearea_depot depot4-3-3 depot4)
  ...
  (in_crate_container crate16 container4)
  (in_crate_container crate17 container4)
  (in_crate_container crate18 container4)
  ...
  (in_storearea_container container-4-0 container4)
  (in_storearea_container container-4-1 container4)
  (in_storearea_container container-4-2 container4)
  ...
  (connected_transitarea_storearea loadarea container-4-0)
  (connected_storearea_transitarea container-4-0 loadarea)
  (connected_transitarea_storearea loadarea container-4-1)
  (connected_storearea_transitarea container-4-1 loadarea)
  (connected_transitarea_storearea loadarea container-4-2)
  (connected_storearea_transitarea container-4-2 loadarea)
  (connected_storearea_transitarea depot0-2-1 loadarea)
  (connected_transitarea_storearea loadarea depot0-2-1)
  (connected_storearea_transitarea depot1-2-1 loadarea)
  (connected_transitarea_storearea loadarea depot1-2-1)
  (connected_storearea_transitarea depot2-2-3 loadarea)
  (connected_transitarea_storearea loadarea depot2-2-3)
  (connected_storearea_transitarea depot3-2-1 loadarea)
  (connected_transitarea_storearea loadarea depot3-2-1)
  (connected_storearea_transitarea depot4-3-2 loadarea)
  (connected_transitarea_storearea loadarea depot4-3-2)
  (clear depot0-2-3)
  (clear depot0-1-2)
  (clear depot0-1-3)
  (clear depot0-1-4)
  ...
  (available hoist0)
  (at_storearea hoist1 depot3-1-3)
  (available hoist1)
  (at_storearea hoist2 depot3-2-3)
  (available hoist2)
  (at_storearea hoist3 depot4-1-1)
  (available hoist3)
  (at_storearea hoist4 depot4-1-3)
  (available hoist4)
)
(:goal   (and (in_crate_depot crate0 depot0)
  ...
  (in_crate_depot crate16 depot4)
  (in_crate_depot crate17 depot4)
  (in_crate_depot crate18 depot4)))
)
