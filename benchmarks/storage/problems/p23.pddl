...
(:init
  ...
  (connected_storearea_transitarea depot3-2-3 loadarea)
  (connected_transitarea_storearea loadarea depot3-2-3)
  (clear depot0-1-1)
  (clear depot0-1-2)
  (clear depot0-1-3)
  (clear depot0-2-1)
  ...
  (available hoist0)
  (at_storearea hoist1 depot1-2-3)
  (available hoist1)
  (at_storearea hoist2 depot2-2-2)
  (available hoist2)
  (at_storearea hoist3 depot3-2-1)
  (available hoist3)
)
