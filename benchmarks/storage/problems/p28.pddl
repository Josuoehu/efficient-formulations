...
(:init
  ...
  (connected_storearea_transitarea depot0-2-4 loadarea)
  (connected_transitarea_storearea loadarea depot0-2-4)
  ...
  (connected_storearea_transitarea depot4-2-1 loadarea)
  (connected_transitarea_storearea loadarea depot4-2-1)
  (clear depot0-1-1)
  (clear depot0-1-2)
  (clear depot0-1-3)
  (clear depot0-2-4)
  ...
  (clear depot4-2-1)
  (clear depot4-2-2)
  (at_storearea hoist0 depot0-1-4)
  (available hoist0)
  (at_storearea hoist1 depot2-2-2)
  (available hoist1)
  (at_storearea hoist2 depot2-1-3)
  (available hoist2)
  (at_storearea hoist3 depot3-1-3)
  (available hoist3)
